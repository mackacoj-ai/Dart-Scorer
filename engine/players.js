// =====================================
// PLAYERS ENGINE
// Replaces EEPROM with localStorage
// =====================================
...
(function () {
    ...
    window.PlayersEngine = {
        ...
        // -------------------------------
        applyMatchResults(p1Stats, p2Stats) {
            const list = loadPlayers();

            function updatePlayer(id, stats) {
            ...
            updatePlayer(p1Stats.id, p1Stats);
            updatePlayer(p2Stats.id, p2Stats);
